...
- `@deepseek-ai/dsh-model-router` — requires `tools` · `llm` · `systemPrompt` ([`packages/routing/model-router/src/index.ts`](../packages/routing/model-router/src/index.ts))
...
- `@deepseek-ai/dsh-tool-git` — requires `tools` · `subprocess` · `systemPrompt` ([`packages/git/tool-git/src/index.ts`](../packages/git/tool-git/src/index.ts))
- `@deepseek-ai/dsh-tool-html-preview` — requires `tools` ([`packages/examples/tool-html-preview/src/index.ts`](../packages/examples/tool-html-preview/src/index.ts))
...
- `@deepseek-ai/dsh-ui-file-explorer` ([`packages/client/ui-file-explorer/src/index.ts`](../packages/client/ui-file-explorer/src/index.ts))
