...
function FlatList({
  useSessions, open, forkSession, onSessionRename, onSessionArchive, onSessionDeleteRequest, archivedSessionIds,
...
export function WorkspaceBrowser({
  ...
  // Session delete is destructive and irreversible (the durable log is
  // removed, unlike archive), so it gets a confirmation dialog — the browser-
  // owned pattern, mirroring the workspace delete dialog below.
