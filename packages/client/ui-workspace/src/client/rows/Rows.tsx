 ...
 * @param props.onDeleteRequest - open the browser-owned session delete-confirmation dialog.
 * @param props.drag - optional draggable-row wiring.
 * @param props.flat - omit the empty status slot in the hierarchy-free flat list.
 * @param props.t - the browser root's locale seat.
 * @returns the session row.
 */
export function SessionNodeItem({ node, currentId, now, onOpen, onRename, onFork, onArchive, onDeleteRequest, drag, flat = false, t }: {
  node: SessionNode
  currentId: string | undefined
  now: number
  ...
  /** Open the browser-owned delete-confirmation dialog for this session (row menu action). */
        ...
        <span className={css.rowActions}>
          <Menu
            ...
            onSelect={(id) => {
              ...
              if (id === 'delete') onDeleteRequest(node.id, title)
            }}
            portal
            closeOnPointerLeave
            anchor={(
