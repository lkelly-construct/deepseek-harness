  ...
  return {
    sessions: {
      ...
      async prompt(request) {
        ...
        // Auto-selecting the preset from the first prompt (via the optional
        // presetRouter service) was removed with preset-router: a one-preset
        // deployment has nothing to classify into.
