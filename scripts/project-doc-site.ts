...
/**
 * Drop the repository badge line that addresses a canonical page's GitHub
 * reader — the site links the repository from every page already, so
 * projecting the badge would repeat it.
 *
