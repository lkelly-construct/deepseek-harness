...
const homeAndGuide: DocsPage[] = [
  ...
  {
    source: 'docs/user/guide/app-preview.md',
    route: 'guide/app-preview.md',
    label: 'Preview the app you are building',
    sidebar: 'guide',
    section: 'Guide',
    order: 3,
  },
...
const reference: DocsPage[] = [
  ...
  ...([
    ...
    source, route, label, sidebar: 'reference', section: 'Concepts', order,
  })),
  ...([
 ...
 * @throws When no section declares this label. Ranking by list membership
